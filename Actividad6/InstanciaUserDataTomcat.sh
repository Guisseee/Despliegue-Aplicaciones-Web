...
IP_Instancia=$(aws ec2 describe-instances --filters "Name=tag:aws:cloudformation:stack-name,Values=$Nombre_Pila" --query "Reservations[0].Instances[0].PublicIpAddress" --output text)
